...
const u16 gMetatiles_PorytilesTest2[] = INCBIN_U16("data/tilesets/primary/porytiles_test_2/metatiles.bin");
const u16 gMetatileAttributes_PorytilesTest2[] = INCBIN_U16("data/tilesets/primary/porytiles_test_2/metatile_attributes.bin");

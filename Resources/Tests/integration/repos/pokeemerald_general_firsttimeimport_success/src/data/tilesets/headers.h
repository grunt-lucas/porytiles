...
const struct Tileset gTileset_PorytilesTest2 =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_PorytilesTest2,
    .palettes = gTilesetPalettes_PorytilesTest2,
    .metatiles = gMetatiles_PorytilesTest2,
    .metatileAttributes = gMetatileAttributes_PorytilesTest2,
    .callback = NULL,
};

...
TEST(Bgr15Tests, ClassInvariantShouldHold) {
    ...
    ASSERT_EQ(bgr_red.red(), 248);

    constexpr Bgr15 bgr_green{0, 251, 0};
    ASSERT_EQ(bgr_green.green(), 248);

    constexpr Bgr15 bgr_blue{0, 0, 255};
    ASSERT_EQ(bgr_blue.blue(), 248);
}

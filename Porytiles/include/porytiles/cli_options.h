...
const std::string WUNUSED_MANUAL_PAL_COLOR = W_GENERAL + WARN_UNUSED_MANUAL_PAL_COLOR;
const std::string WNO_UNUSED_MANUAL_PAL_COLOR = W_GENERAL + "no-" + WARN_UNUSED_MANUAL_PAL_COLOR;

...
EncounterType stringToEncounterType(const std::string &string) {
    ...
    if (string == "TILE_ENCOUNTER_LAND") {
        return EncounterType::LAND;
    }
    if (string == "TILE_ENCOUNTER_WATER") {
...
TEST_CASE("RGBA32 to BGR15 should lose precision") {
    porytiles_legacy::RGBA32 rgb1 = {0, 1, 2, 3};
    porytiles_legacy::RGBA32 rgb2 = {255, 255, 255, 255};

    porytiles_legacy::BGR15 bgr1 = rgbaToBgr(rgb1);
    porytiles_legacy::BGR15 bgr2 = rgbaToBgr(rgb2);

    CHECK(bgr1 == porytiles_legacy::BGR15{0});
    CHECK(bgr2 == porytiles_legacy::BGR15{32767}); // this value is uint16 max divided by two, i.e. 15 bits are set
}

TEST_CASE("RGBA32 should be ordered component-wise") {
    porytiles_legacy::RGBA32 rgb1 = {0, 1, 2, 3};
    porytiles_legacy::RGBA32 rgb2 = {1, 2, 3, 4};
    porytiles_legacy::RGBA32 rgb3 = {2, 3, 4, 5};
    porytiles_legacy::RGBA32 zeros = {0, 0, 0, 0};
...
TEST_CASE("BGR15 to RGBA should upconvert RGB channels to multiples of 8") {
    porytiles_legacy::RGBA32 rgb1 = {0, 8, 80, 255};
    porytiles_legacy::RGBA32 rgb2 = {255, 255, 255, 255};
    porytiles_legacy::RGBA32 rgb3 = {2, 165, 96, 255};

    porytiles_legacy::BGR15 bgr1 = rgbaToBgr(rgb1);
    porytiles_legacy::BGR15 bgr2 = rgbaToBgr(rgb2);
    porytiles_legacy::BGR15 bgr3 = rgbaToBgr(rgb3);

    CHECK(porytiles_legacy::bgrToRgba(bgr1) == porytiles_legacy::RGBA32{0, 8, 80, 255});
    CHECK(porytiles_legacy::bgrToRgba(bgr2) == porytiles_legacy::RGBA32{248, 248, 248, 255});
    CHECK(porytiles_legacy::bgrToRgba(bgr3) == porytiles_legacy::RGBA32{0, 160, 96, 255});
}
#endif // DOCTEST_CONFIG_DISABLE

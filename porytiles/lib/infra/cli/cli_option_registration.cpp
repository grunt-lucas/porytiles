...
void register_config_options(CLI::App &app, CliOptionStorage &storage)
{
    ...
    // Import Transparency (enum ImportTransparencyMode, captured as string, parsed by CliOptionProvider)
    config_group
        ->add_option(
            "--import-transparency",
            storage.import_transparency,
        ...
        ->type_name("{alpha|extrinsic|mixed}");
    ...
    // Metatile Attribute Size (optional std::size_t, captured as string, parsed by CliOptionProvider)
    config_group->add_option(

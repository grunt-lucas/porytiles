...
/// @brief Concrete implementation of UserDiagnostics that outputs structured messages to stderr, optionally with
/// colored formatting.
///
/// @details
/// StderrStyledUserDiagnostics provides a terminal-based implementation of the UserDiagnostics interface. It outputs
/// all diagnostic messages to stderr with some additional pretty-print structuring. If provided with an
...
class StderrStyledUserDiagnostics final : public UserDiagnostics {
  public:
    ...
    ///
    /// @details
    /// Outputs informational messages with blue "remark:" prefix and tag suffix on the first line, formatted as
    /// "remark: <message> [<tag>]" with appropriate indentation for subsequent lines.
    ///

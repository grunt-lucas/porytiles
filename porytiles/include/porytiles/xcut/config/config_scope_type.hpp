 ...
 * configuration values. This allows the same configuration key to have different values depending on whether it's being
 * used in a tileset or layout context.
 *

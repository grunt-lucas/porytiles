...
[[nodiscard]] inline std::vector<CliOptionMeta> get_cli_option_metadata()
{
    return {
        ...
        CliOptionMeta{
            ...
            "Extrinsic Transparency - The RGB color to treat as transparent during compilation. (format: R,G,B or R,G,B,A)",
            "color",
            {},
            false
        },
        ...
        CliOptionMeta{
            ...
            "enum",
            { "scan-local-metatiles", "palette-00", "palette-01", "palette-02", "palette-03", "palette-04", "palette-05", "palette-06", "palette-07", "palette-08", "palette-09", "palette-10", "palette-11", "palette-12", "palette-13", "palette-14", "palette-15", "internal-png-palette", "scan-all-tilesets" },
            false
        },
        CliOptionMeta{

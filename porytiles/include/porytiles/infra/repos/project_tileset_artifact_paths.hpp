...
///
/// @details
/// TilesetArtifactPaths holds the actual file paths extracted from INCBIN macro declarations in pokeemerald's
/// graphics.h and metatiles.h files (and a few other assorted files):
/// @code
/// // From graphics.h:

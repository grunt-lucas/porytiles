...
///
/// @details
/// This provider returns default values for all configuration parameters. It's useful as a base layer in a
/// configuration system where other providers can override specific values.

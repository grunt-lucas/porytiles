...
///
/// The generated code follows the pattern used by vanilla pokeemerald animations, making it compatible with the
/// existing tileset animation infrastructure.
///
/// Usage:
/// @code
...
class AnimCodeGenerator {
  public:
    ...
    ///
    /// @details
    /// Produces a complete C header file containing all animation code for a tileset. The generated code includes
    /// proper include guards, INCBIN macro definitions (if not already defined), and all animation functions.
    ///

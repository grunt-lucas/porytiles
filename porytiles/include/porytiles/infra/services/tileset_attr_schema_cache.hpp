...
/// the two can resolve different schemas (per-tileset metatile_attr_field_overrides, or use_frlg_alternate_masks
...
class TilesetAttrSchemaCache {
  public:
    ...
    TilesetAttrSchemaCache(
        std::filesystem::path project_root,
        gsl::not_null<const TilesetAttrSchemaResolver *> resolver,
  ...
  private:
    ...
    const TilesetAttrSchemaResolver *resolver_;

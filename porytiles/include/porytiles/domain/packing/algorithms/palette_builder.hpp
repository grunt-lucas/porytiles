...
/// Users can inspect these records to identify which prefilled destination slots are blocking tile sharing alignment
/// and potentially rearrange them.
...
/// ishax-kos (https://github.com/ishax-kos/borytiles), specifically its @c compilation.rs module. Porytiles

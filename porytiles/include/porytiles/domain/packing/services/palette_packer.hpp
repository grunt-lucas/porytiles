...
///
/// @details
/// PalettePacker solves the "Pagination Problem" (Bin Packing with Overlapping Items) - assigning tiles to palettes
/// such that each tile's colors fit within a single palette's capacity, while minimizing the number of palettes used.
///

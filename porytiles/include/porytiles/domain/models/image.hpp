...
///
/// @details
/// Clients who need to operate on images can use this class to read image data and manipulate image contents. This
/// value type makes no assumptions about the underlying image storage format. Image provides an optional palette field
/// for images which want to store an IndexPixel pixel type into a fixed palette of colors.
///

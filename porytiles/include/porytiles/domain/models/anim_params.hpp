...
class AnimParams {
  public:
    ...
    ///
    /// @details
    /// Lists all unique animation frame files. The position in this vector determines the FrameN index used in
    /// generated C code. For example, ["center", "left", "right"] means center.png is Frame0, left.png is Frame1,
    /// right.png is Frame2. Frame names can be arbitrary strings (not just numbers).
    ///

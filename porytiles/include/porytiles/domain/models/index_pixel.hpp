...
class IndexPixel {
  public:
     ...
     *
     * @details
     * In true-color mode, the full 8-bit index encodes both the palette index (upper 4 bits) and the color index within
     * that palette (lower 4 bits). This method extracts just the color index, which is what GBA hardware uses to look
     * up colors in the selected palette.
     *
     ...
     * @details
     * In true-color mode, the full 8-bit index encodes both the palette index (upper 4 bits) and the color index within
     * that palette (lower 4 bits). This method extracts the palette index, which identifies which of the 16 possible
     * palettes this pixel's color belongs to.
     *

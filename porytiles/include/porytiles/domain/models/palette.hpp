...
#include "porytiles/domain/models/palette_index.hpp"
...
class Palette {
  public:
    ...
    /// If you need to match tiles where the palette may have duplicate colors, use color-equivalence comparison
    /// (compare the actual palette colors at each index) rather than direct index comparison. See

...
///
/// @details
/// TokenType defines all token categories the lexer can produce. The initial implementation focuses on tokens needed
/// for #define parsing, but additional token types are included for future expansion to support functions,
/// conditionals, and other C constructs.
...
///
/// @details
/// Token captures the type, textual representation, parsed value (if applicable), and source position of a lexical
/// unit. For integer literals, the parsed numeric value is stored in int_value_. For identifiers and string literals,

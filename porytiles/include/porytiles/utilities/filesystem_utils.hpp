...
///
/// @details
/// Creates a new directory in the system's temporary directory path with a random hex suffix. The directory name
/// follows the pattern "porytiles_<random_hex>". If directory creation fails (e.g., due to a collision), it retries up
/// to 1000 times before panicking.
///

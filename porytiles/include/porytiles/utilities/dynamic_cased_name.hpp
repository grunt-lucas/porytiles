...
/// simple string manipulation is lossy. Particularly, round-trips through snake_case lose information about the
/// original underscore positions vs PascalCase word boundaries.
///

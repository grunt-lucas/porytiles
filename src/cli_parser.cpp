...
const std::string HELP_DESCRIPTION = "    -" + std::string{HELP_SHORT} + ", --" + HELP_LONG +
                                     "\n"
                                     "        Print help message.\n";

const std::string VERBOSE_LONG = "verbose";
constexpr char VERBOSE_SHORT = "v"[0];
const std::string VERBOSE_DESCRIPTION = "    -" + std::string{VERBOSE_SHORT} + ", --" + VERBOSE_LONG +
                                        "\n"
                                        "        Enable verbose logging to stdout.\n";

const std::string VERSION_LONG = "version";
constexpr char VERSION_SHORT = "V"[0];
const std::string VERSION_DESCRIPTION = "    -" + std::string{VERSION_SHORT} + ", --" + VERSION_LONG +
                                        "\n"
                                        "        Print version info.\n";

const std::string OUTPUT_LONG = "output";
constexpr char OUTPUT_SHORT = "o"[0];
const std::string OUTPUT_DESCRIPTION = "    -" + std::string{OUTPUT_SHORT} + ", --" + OUTPUT_LONG +
                                       "=<PATH>\n"
...
const std::string GLOBAL_HELP = "porytiles " + VERSION + " " + RELEASE_DATE +
                                "\n"
...
const std::string COMPILE_RAW_HELP = "Usage:\n"
                                     "    porytiles " +
                                     COMPILE_RAW_COMMAND +
                                     " [OPTIONS] TILES\n"
                                     "    porytiles " +
                                     COMPILE_RAW_COMMAND +
                                     " [OPTIONS] --secondary TILES TILES_PRIMARY\n"
                                     "\n"
...
const std::string COMPILE_HELP =
    ...
    "    porytiles " +
    COMPILE_COMMAND +
    " [OPTIONS] --secondary BOTTOM MIDDLE TOP BOTTOM-PRIMARY MIDDLE-PRIMARY TOP-PRIMARY\n"
    "\n"

...
TEST(ProjectPathsTests, PrimaryTilesetPngFilesShouldWork) {
    ...
    EXPECT_EQ(paths.primary_top_png("general"), "/foo/bar/data/tilesets/primary/general/porytiles/top.png");

    EXPECT_EQ(paths.primary_bottom_png("building"), "/foo/bar/data/tilesets/primary/building/porytiles/bottom.png");
    EXPECT_EQ(paths.primary_middle_png("building"), "/foo/bar/data/tilesets/primary/building/porytiles/middle.png");
    EXPECT_EQ(paths.primary_top_png("building"), "/foo/bar/data/tilesets/primary/building/porytiles/top.png");
}
...
TEST(ProjectPathsTests, SecondaryTilesetPngFilesShouldWork) {
    ...
    EXPECT_EQ(paths.secondary_top_png("route_104"), "/foo/bar/data/tilesets/secondary/route_104/porytiles/top.png");
}

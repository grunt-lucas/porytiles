...
class ProjectCSourceFileAppenderTest : public ::testing::Test {
  protected:
    void SetUp() override {
        ...
        // Create test files
        create_test_file(src_dir / "graphics.h", "// Graphics header\n");
        create_test_file(src_dir / "headers.h", "// Headers header\n");
    ...
    void create_test_file(const std::filesystem::path &file_path, const std::string &content) {
...
TEST_F(ProjectCSourceFileAppenderTest, AppendToGraphicsHeaderShouldWork) {
    ...
    const auto content = read_file(graphics_path);
...
TEST_F(ProjectCSourceFileAppenderTest, AppendToHeadersHeaderShouldWork) {
    ...
    const auto content = read_file(headers_path);
...
TEST_F(ProjectCSourceFileAppenderTest, AppendToMetatilesHeaderShouldWork) {
    ...
    const auto content = read_file(metatiles_path);
...
TEST_F(ProjectCSourceFileAppenderTest, AppendWithComplexTilesetNameShouldWork) {
    ...
    const auto content = read_file(project_paths_->graphics_header());

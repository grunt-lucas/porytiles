...
TEST_F(TextualCSourceGeneratorTest, GeneratePaletteDeclarationShouldWork) {
    ...
    EXPECT_TRUE(result.find("data/tilesets/primary/my_tileset/palettes/00.gbapal") != std::string::npos);
    EXPECT_TRUE(result.find("data/tilesets/primary/my_tileset/palettes/12.gbapal") != std::string::npos);
...
TEST_F(TextualCSourceGeneratorTest, GenerateTilesetStructDefinitionShouldWork) {
    ...
    EXPECT_TRUE(result.find(".metatileAttributes = gMetatileAttributes_MyTileset") != std::string::npos);
...
TEST_F(TextualCSourceGeneratorTest, GenerateMetatileAttributeDeclarationShouldWork) {
    ...
    // Should contain correct path
    EXPECT_TRUE(result.find("data/tilesets/primary/my_tileset/metatile_attributes.bin") != std::string::npos);

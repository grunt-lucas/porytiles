...
TEST(RgbaImageTest, AtByIndexShouldWork) {
  ...
  const Rgba32 red_pixel{255, 0, 0, 255};
  const Rgba32 green_pixel{0, 255, 0, 255};
  const Rgba32 blue_pixel{0, 0, 255, 255};
...
TEST(RgbaImageTest, SetByIndexShouldWork) {
  ...
  const Rgba32 yellow_pixel{255, 255, 0, 128};
  const Rgba32 magenta_pixel{255, 0, 255, 200};
...
TEST(RgbaImageTest, SetByRowColShouldWork) {
  ...
  const Rgba32 cyan_pixel{0, 255, 255, 100};
  const Rgba32 purple_pixel{128, 0, 255, 50};
...
TEST(RgbaImageTest, IndexAndRowColCorrespondence) {
  ...
  const Rgba32 test_pixel{128, 64, 32, 16};
  ...
  const Rgba32 another_pixel{200, 100, 50, 25};
...
TEST(RgbaImageTest, SinglePixelImage) {
  ...
  const Rgba32 single_pixel{42, 84, 126, 168};
...
TEST(RgbaImageTest, AtByIndexOutOfBoundsPanic) {
  ...
  EXPECT_EXIT(std::ignore = image.At(6), ::testing::KilledBySignal(SIGABRT), "index 6 out of bounds for image size 6");
  EXPECT_EXIT(std::ignore = image.At(100), ::testing::KilledBySignal(SIGABRT), "index 100 out of bounds for image size 6");
}
...
TEST(RgbaImageTest, AtByRowColColumnOutOfBoundsPanic) {
  ...
  EXPECT_EXIT(std::ignore = image.At(0, 3), ::testing::KilledBySignal(SIGABRT), "col 3 out of bounds for image width 3");
  EXPECT_EXIT(std::ignore = image.At(1, 10), ::testing::KilledBySignal(SIGABRT), "col 10 out of bounds for image width 3");
}
...
TEST(RgbaImageTest, AtByRowColRowOutOfBoundsPanic) {
  ...
  EXPECT_EXIT(std::ignore = image.At(2, 0), ::testing::KilledBySignal(SIGABRT), "row 2 out of bounds for image height 2");
  EXPECT_EXIT(std::ignore = image.At(5, 1), ::testing::KilledBySignal(SIGABRT), "row 5 out of bounds for image height 2");
}
...
TEST(RgbaImageTest, SetByIndexOutOfBoundsPanic) {
  ...
  const std::size_t height = 2;
  RgbaImage image{width, height};
  const Rgba32 test_pixel{255, 0, 0, 255};

  EXPECT_EXIT(image.Set(4, test_pixel), ::testing::KilledBySignal(SIGABRT), "index 4 out of bounds for image size 4");
  EXPECT_EXIT(image.Set(50, test_pixel), ::testing::KilledBySignal(SIGABRT), "index 50 out of bounds for image size 4");
}
...
TEST(RgbaImageTest, SetByRowColColumnOutOfBoundsPanic) {
  ...
  EXPECT_EXIT(image.Set(0, 2, test_pixel), ::testing::KilledBySignal(SIGABRT), "col 2 out of bounds for image width 2");
  EXPECT_EXIT(image.Set(1, 5, test_pixel), ::testing::KilledBySignal(SIGABRT), "col 5 out of bounds for image width 2");
}
...
TEST(RgbaImageTest, SetByRowColRowOutOfBoundsPanic) {
  ...
  EXPECT_EXIT(image.Set(2, 0, test_pixel), ::testing::KilledBySignal(SIGABRT), "row 2 out of bounds for image height 2");
  EXPECT_EXIT(image.Set(10, 1, test_pixel), ::testing::KilledBySignal(SIGABRT), "row 10 out of bounds for image height 2");
}
 ...
 * result computation. This type alias is a convenient wrapper for the stdlib `std::expected`, which provides this
 * exact functionality. The `std::string` error type will typically be some description of what went wrong.
 *

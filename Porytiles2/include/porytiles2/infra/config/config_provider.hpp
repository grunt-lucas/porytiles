...
class ConfigProvider {
  public:
    ...
    [[nodiscard]] virtual LayerValue<AnimPalResolutionStrategy> anim_pal_resolution_strategy(ConfigScopeType type, const std::string &scope) const;

    [[nodiscard]] virtual LayerValue<AnimKeyFrameResolutionStrategy> anim_key_frame_resolution_strategy(ConfigScopeType type, const std::string &scope) const;

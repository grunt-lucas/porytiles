...
/**
 * @brief A DiagConsumer implementation that simply ignores the provided
 * diagnostic.
 */
...
/**
 * @brief A DiagConsumer implementation that pushes diagnostic messages to
 * `stderr`.
 */
...
/**
 * @brief A DiagConsumer implementation that pushes diagnostic messages to an
 * internal `vector`.
 */

...
class TilesetArtifactKeyProvider {
  public:
     ...
     */
    [[nodiscard]] virtual std::any key_for(const std::string &tileset_name, const TilesetArtifact &artifact) const = 0;
     ...
     */
    [[nodiscard]] virtual bool exists(const std::any &key) const = 0;
};

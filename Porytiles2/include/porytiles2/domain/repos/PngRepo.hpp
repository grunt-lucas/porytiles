...
public:
   ...
   * in valid PNG format, it returns an error message. Otherwise, the
   * initialized Png is returned.
   *
   * @param path The path of the Png to import.
   * @return A std::unique_ptr to the imported Png, otherwise a std::string

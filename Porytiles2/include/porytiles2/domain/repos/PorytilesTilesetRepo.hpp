 ...
 *
 * @details
 * The PorytilesTilesetRepo makes no assumptions about the structure of the
 * backing store for the PorytilesTileset. Presumably, this store is the
 * canonical 'data/tilesets' directory, but the details here are
...
public:
   ...
   * @return A PorytilesTileset Result on success, otherwise an error
   * description.
   */
  virtual Result<std::unique_ptr<PorytilesTileset>>

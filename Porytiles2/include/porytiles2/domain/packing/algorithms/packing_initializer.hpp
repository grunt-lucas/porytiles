 ...
 *
 * After this function returns, the caller can use the modified palette pool for strategy-specific initialization (e.g.,
 * creating empty palettes for remaining slots).
 *

...
template <>
struct std::formatter<porytiles2::AnimMultiPalSubtileResolutionStrategy> {
    constexpr auto parse(std::format_parse_context &ctx)
    {
        return ctx.begin();
    }

    auto format(const porytiles2::AnimMultiPalSubtileResolutionStrategy &value, auto &ctx) const
    {

...
/**
 * @brief Service for converting normalized tiles back to RGBA tile format.
 *
 * @details
 * The RgbaTileDenormalizer provides functionality to convert NormalizedTile instances back to RgbaTile format. It
 * supports two modes of conversion:
...
class RgbaTileDenormalizer {
  public:
     ...
     */
    [[nodiscard]] RgbaTile to_rgba_preserving_flips(const NormalizedTile<Rgba32> &normalized_tile) const;
};

...
/**
 * @brief A domain service that provides functionality to compile PorytilesTileset to PorymapTileset.
 */
class TilesetCompilerService {
  public:
     ...
     */
    virtual Result<std::unique_ptr<PorymapTileset>> CompilePrimary(const PorytilesTileset &tileset) = 0;

    /**
     * @brief Compiles a secondary PorytilesTileset to a PorymapTileset, using a given paired primary PorymapTileset.
     *
     * @param tileset The PorytilesTileset to compile.
     * @param primary_tileset The paired primary PorymapTileset.
     * @return A pointer to the resulting PorymapTileset or a description of the compilation error.
     */
    virtual Result<std::unique_ptr<PorymapTileset>> CompileSecondary(const PorytilesTileset &tileset,

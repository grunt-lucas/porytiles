...
class PrimaryTilesetImporter {
  public:
    ...
    /**
     * @brief Import a vanilla tileset from the vanilla backing store
     * @param tileset_name
     * @return
     */
    [[nodiscard]] virtual ChainableResult<PorymapTilesetComponent>
    import_from_vanilla(const std::string &tileset_name) const = 0;

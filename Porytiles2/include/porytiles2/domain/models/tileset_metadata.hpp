 ...
 *
 * @details
 * TilesetMetadata captures the key fields from a pokeemerald tileset struct definition:
 * @code
 ...
 * @endcode
 *
 * This domain model enables determining:
 ...
 *
 * The variable names can then be used to look up INCBIN declarations and resolve actual file paths.
 *

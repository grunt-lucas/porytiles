...
class CompileLayout {
  public:
    /**
     * @brief Constructs a CompileLayout use case with the given repositories and compilation service.
     *
     * @param porytiles_repo A pointer to the PorytilesLayoutRepo for this use case.
     * @param porymap_repo A pointer to the PorymapLayoutRepo for this use case.
     * @param compiler_service A pointer to the LayoutCompilerService for this use case.
     */
    CompileLayout(std::unique_ptr<PorytilesLayoutRepo> porytiles_repo, std::unique_ptr<PorymapLayoutRepo> porymap_repo,
     ...
     *
     * @details
     * Given a layout by name, compile the PorytilesLayout assets into PorymapLayout assets. Uses the use
     * case's configured repos to load and save the layout assets. Uses the given LayoutCompilerService to perform

...
/**
 * @brief Use case for compiling a secondary PorytilesTileset.
 */
class CompileSecondaryTileset {
  public:
    /**
     * @brief Constructs a CompileSecondaryTileset use case with the given repositories and compilation service.
     *
     ...
     */
    CompileSecondaryTileset(std::unique_ptr<PorytilesTilesetRepo> porytiles_repo,
     ...
     *
     * @details
     * Given a secondary tileset by name, compile the PorytilesTileset assets into PorymapTileset assets. Uses the use
     ...
     *
     * @param tileset The name of the secondary tileset to compile.

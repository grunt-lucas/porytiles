...
public:
  /**
   * @brief Constructs a CompileSecondaryTileset use case with the given
   * repositories and compilation service.
   *
   * @param porytiles_repo A pointer to the PorytilesTilesetRepo for this use
   * case.
  ...
  CompileSecondaryTileset(
      std::unique_ptr<PorytilesTilesetRepo> porytiles_repo,
   ...
   *
   * @details
   * Given a secondary tileset by name, compile the PorytilesTileset assets into

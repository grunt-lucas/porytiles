...
/**
 * @brief Unwraps a tileset-scoped config value from a DomainConfig, AppConfig, or InfraConfig object, returning early
 * if the value is not available.
 *
 * @details
 * This macro retrieves a config value for a given tileset and automatically handles the error case. If the config value
 ...
 */
#define PT_UNWRAP_TILESET_CONFIG(ptr, config, tileset_name, return_type)                                               \

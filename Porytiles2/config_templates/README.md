...
This directory contains the Porytiles2 configuration code generation system. Configuration values are defined in YAML and C++ code is auto-generated using Jinja2 templates.
...
enum_types:
  ...
  - cpp_type: MyEnumType                                        # C++ class name
    header_path: porytiles2/domain/config/my_enum_type.hpp      # Output path
...
- `include/porytiles2/domain/config/my_enum_type.hpp` with:
...
| Template | Output |
|----------|--------|
| `domain/config/domain_config.hpp.jinja2` | `include/porytiles2/domain/config/domain_config.hpp` |
| `app/config/app_config.hpp.jinja2` | `include/porytiles2/app/config/app_config.hpp` |
| `infra/config/infra_config.hpp.jinja2` | `include/porytiles2/infra/config/infra_config.hpp` |

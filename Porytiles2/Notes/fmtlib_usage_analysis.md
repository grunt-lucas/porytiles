...
This document catalogs all uses of the fmtlib dependency outside of the `Porytiles2/include/porytiles2/utilities/text` module. The goal is to identify locations that should potentially be refactored to use the TextFormatter functionality to maintain implementation agnosticism in domain and app code.
...
##### **Porytiles2/include/porytiles2/domain/model/tile.hpp**
...
##### **Porytiles2/include/porytiles2/domain/model/normalized_tile.hpp**
- **Usage:** `fmt::format()` in multiple methods
- **Primary uses:** Panic messages, string representations
- **Refactor Priority:** MEDIUM

##### **Porytiles2/include/porytiles2/domain/model/image.hpp**
- **Usage:** `fmt::format()` for bounds checking and error messages
- **Refactor Priority:** MEDIUM

##### **Porytiles2/include/porytiles2/domain/model/metatile.hpp**
...
##### **Porytiles2/lib/domain/model/porymap_tileset_component.cpp**
- **Usage:** `fmt::format()` for error messages
- **Refactor Priority:** MEDIUM

#### Domain Services

##### **Porytiles2/lib/domain/services/rgba_image_tileizer.cpp**
...
##### **Porytiles2/lib/domain/services/rgba_tile_normalizer.cpp**
- **Usage:** Similar FormattableError pattern
- **Refactor Priority:** HIGH

##### **Porytiles2/lib/domain/services/rgba_layer_image_metatileizer.cpp**
- **Usage:** FormattableError formatting
- **Refactor Priority:** HIGH

#### Domain Orchestration

##### **Porytiles2/lib/domain/orchestration/pipeline.cpp**
- **Usage:** `fmt::format()` for error and status messages
- **Refactor Priority:** MEDIUM

##### **Porytiles2/include/porytiles2/domain/orchestration/operation.hpp**
- **Usage:** `fmt::format()` for operation messages
- **Refactor Priority:** MEDIUM

#### Domain Repositories

##### **Porytiles2/lib/domain/repos/tileset_repo.cpp**
...
##### **Porytiles2/lib/infra/services/png_rgba_image_saver.cpp**
##### **Porytiles2/lib/infra/services/png_indexed_image_saver.cpp**
##### **Porytiles2/lib/infra/services/png_indexed_image_loader.cpp**
##### **Porytiles2/lib/infra/services/jasc_pal_saver.cpp**
##### **Porytiles2/lib/infra/services/jasc_pal_loader.cpp**
##### **Porytiles2/lib/infra/services/project_artifact_checksum_provider.cpp**
- **Usage:** `fmt::format()` for error messages and file I/O errors
- **Refactor Priority:** MEDIUM - Infrastructure error reporting

#### Infrastructure Repositories

##### **Porytiles2/lib/infra/repos/project_tileset_artifact_reader.cpp**
##### **Porytiles2/lib/infra/repos/project_tileset_artifact_writer.cpp**
##### **Porytiles2/lib/infra/repos/project_tileset_artifact_key_provider.cpp**
...
##### **Porytiles2/include/porytiles2/infra/diagnostics/diagnostics.hpp**
##### **Porytiles2/include/porytiles2/infra/diagnostics/diagnostic_engine.hpp**
##### **Porytiles2/lib/infra/diagnostics/diagnostics.cpp**
##### **Porytiles2/lib/infra/diagnostics/diagnostic_engine.cpp**
...
##### **Porytiles2/lib/app/use_cases/compile_primary_tileset.cpp**
##### **Porytiles2/lib/app/use_cases/import_primary_tileset.cpp**
...
##### **Porytiles2/include/porytiles2/utilities/string_utils.hpp**
...
##### **Porytiles2/tools/driver/main.cpp**
##### **Porytiles2/tools/driver/validators.hpp**
- **Usage:** `fmt::format()` for CLI output and validation messages
- **Refactor Priority:** HIGH - User-facing interface

### 7. Tests

##### **Porytiles2/tests/unit/domain/model/tile_test.cpp**
##### **Porytiles2/tests/unit/domain/model/rgba_tile_test.cpp**
##### **Porytiles2/tests/unit/domain/model/rgba32_test.cpp**
...
- The text module (`Porytiles2/lib/utilities/text/text_formatter.cpp`) itself uses fmtlib internally, which is appropriate as it's the abstraction layer

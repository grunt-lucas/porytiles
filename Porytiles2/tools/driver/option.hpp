...
public:
  ...
  [[nodiscard]] std::string NameShort() const override { return "-o"; }

  [[nodiscard]] std::string NameLong() const override { return "--output"; }
  ...
  [[nodiscard]] std::string output_path() const { return output_path_; }
};
...
public:
  OptTilesPalMode() : pal_format_{tiles_pal_mode_to_str(porytiles::TilesPalMode::kTrueColor)} {}
  ...
  [[nodiscard]] std::string pal_format() const { return pal_format_; }
};
...
public:
  ...
  [[nodiscard]] bool dual_layer() const { return triple_layer_; }
};
...
public:
  ...
  [[nodiscard]] const std::string &rgb() const { return rgb_; }
};

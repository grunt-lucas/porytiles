...
static const std::filesystem::path kTilesetPrimaryRootPath = std::filesystem::path{"data"} / "tilesets" / "primary";
static const std::filesystem::path kTilesetSecondaryRootPath = std::filesystem::path{"data"} / "tilesets" / "secondary";

...
const (
	...
	// This makes it easy to see the index value of each pixel. The tradeoff is
	// that it's not obvious which actual palette (i.e. which color) each pixel
	// is actually using.
	Greyscale
)
...
// more convenient way to set the fieldmap parameters for a Porytiles job. Think
// of it like a preset for the FieldmapConfig.
...
// FieldmapConfig is Porytiles's internal representation of the fieldmap defines
// at the very top of 'include/fieldmap.h'.
...
// EmeraldDefaults creates a FieldmapConfig with corresponding to Emerald's
// 'include/fieldmap.h' configuration.
...
// FireRedDefaults creates a FieldmapConfig with corresponding to FireRed's
// 'include/fieldmap.h' configuration.
...
// RubyDefaults creates a FieldmapConfig with corresponding to Ruby's
// 'include/fieldmap.h' configuration.

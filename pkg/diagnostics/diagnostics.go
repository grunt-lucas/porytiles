...
const (
	...
	// previous diagnostic of a higher severity level. Diagnostics can define
	// zero or more notes that the DiagnosticEngine should emit alongside the
	// main diagnostic message. Notes provide additional context to help users
	// resolve issues.
	...
	// on-the-fly edit of the input data, etc. Unlike Note, Remark can be
	// freestanding.
...
// reporting.
//
// The DiagnosticEngine uses a DiagnosticTemplate to construct the actual
...
func diagnosticTemplate(diagName string) DiagnosticTemplate {

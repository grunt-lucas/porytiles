...
| Support for animated tiles, i.e. correctly generate `anims` folder content and stable placement in `tiles.png`  | ⚠️ | partial [trunk](https://github.com/grunt-lucas/porytiles/tree/trunk) |
